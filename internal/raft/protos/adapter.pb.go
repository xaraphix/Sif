...
type RaftInfoResponse struct {
	...
	NodeId        int32 `protobuf:"varint,1,opt,name=NodeId,proto3" json:"NodeId,omitempty"`
	CurrentLeader int32 `protobuf:"varint,2,opt,name=CurrentLeader,proto3" json:"CurrentLeader,omitempty"`
...
func (x *RaftInfoResponse) GetNodeId() int32 {
	if x != nil {
		return x.NodeId
	}
	return 0
...
func (x *RaftInfoResponse) GetCurrentLeader() int32 {
	if x != nil {
...
var file_internal_raft_protos_adapter_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x06, 0x4e, 0x6f, 0x64, 0x65, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x0d, 0x43, 0x75, 0x72,
	0x72, 0x65, 0x6e, 0x74, 0x4c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05,
